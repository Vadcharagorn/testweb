...
--
-- Host: 127.0.0.1
-- Generation Time: Mar 09, 2021 at 06:01 AM
...
('00002', 'เก็บตะวัน', '002', '03', 'WRP', 250, 3, 3, NULL, '2554-03-20'),
('00003', 'สิ่งมีชีวิต', '002', '01', 'ํYPR', 185, 3, 3, NULL, '2553-03-25');
...
CREATE TABLE IF NOT EXISTS `customer` (
  ...
  `CustomeSurname` varchar(30) NOT NULL,
...
INSERT INTO `customer` (`CustomerID`, `CustomerName`, `CustomeSurname`, `CustomerAddr`, `CustomerPhone`) VALUES
